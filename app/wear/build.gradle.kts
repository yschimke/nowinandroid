...
dependencies {
    ...
    implementation(projects.feature.wearTile)
    implementation(projects.feature.wearHome)
    implementation(projects.feature.wearActivity)
    implementation(projects.feature.wearLogin)
